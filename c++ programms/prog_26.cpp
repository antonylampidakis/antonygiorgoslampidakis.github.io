...
{
public:
	EmbeddedSys(const string&, const string&, int = 0, int = 0, int = 0, int = 0, int = 0, int = 0);
...
int main()
{
	...
	DKit dkit("Amd", "Ryzen", 8, 4, 2, 2, 1);

	EmbeddedSys embeddedsys("Siemens", "587i", 4, 2, 2, 1, 2, 1);
